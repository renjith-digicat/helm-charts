...
| `image.tag`                                       | veritable-ui image tag (immutable tags are recommended)                                                                                                 | `v0.3.10`                   |
...
| `livenessProbe.path`                              | Path for to check for livenessProbe                                                                                                                     | `/connections`              |
...
| `readinessProbe.path`                             | Path for to check for readinessProbe                                                                                                                    | `/connections`              |
...
| `startupProbe.path`                               | Path for to check for startupProbe                                                                                                                      | `/connections`              |
