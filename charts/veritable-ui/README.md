...
| `image.tag`                                       | veritable-ui image tag (immutable tags are recommended)                                                                                                 | `v0.3.7`                                                         |
...
| `readinessProbe.path`                             | Path for to check for readinessProbe                                                                                                                    | `/`                                                              |
...
| `startupProbe.path`                               | Path for to check for startupProbe                                                                                                                      | `/`                                                              |
