...
| `image.debug`                                     | Enable wasp-event-service image debug mode                                                                                                                    | `false`                           |
...
| `service.ports.http`               | wasp-event-service service HTTP port                                                                                             | `3000`                     |
...
| `initEvents.image.registry`      | Kafka image registry                                                                                                                                  | `docker.io`          |
