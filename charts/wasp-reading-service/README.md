...
| `image.debug`                                     | Enable wasp-reading-service image debug mode                                                                                                                    | `false`                             |
...
| `autoscaling.minReplicas`                         | Minimum number of wasp-reading-service replicas                                                                                                                 | `""`                                |
...
| `initReadings.topic`             | Topic to create                                                                                                                                       | `readings`           |
