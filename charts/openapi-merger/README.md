...
| `security.type`                                   | Options are ["bearer", "oauth2", ""] to enable security configuration in the merged OpenAPI spec                                                          | `""`                                                                                                                                                                                                                  |
| `security.oauth2.authorizationUrl`                | The URL for the oauth2 authorization                                                                                                                      | `/auth/realms/simple/protocol/openid-connect/auth`                                                                                                                                                                    |
| `security.oauth2.tokenUrl`                        | The URL for the oauth2 token                                                                                                                              | `/auth/realms/simple/protocol/openid-connect/token`                                                                                                                                                                   |
| `security.oauth2.scopes`                          | Scopes for the oauth2 token                                                                                                                               |                                                                                                                                                                                                                       |
